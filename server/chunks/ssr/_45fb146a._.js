...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/card.tsx [app-ssr] (ecmascript)"); // Import CardFooter
...
function VideoCallPage() {
    ...
    const requestCameraPermission = async ()=>{
        ...
        try {
            ...
            // Automatically start/join the meeting once permission is granted
            if (generatedCode) {
                handleStartMeeting(generatedCode);
            } else if (meetingCode) {
                handleJoinMeeting();
            }
        // If neither, permission is granted but user hasn't clicked start/join yet
        } catch (error) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Only request if we intend to start a meeting and permission status is unknown
        if ((isMeetingActive || meetingCode || generatedCode) && hasCameraPermission === null) {
            requestCameraPermission();
        }
        // Cleanup function to stop media stream when component unmounts or meeting ends
        return ()=>{
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
        ...
        meetingCode,
        generatedCode
    ]); // Rerun if meeting state changes
    const handleJoinMeeting = ()=>{
        ...
        if (hasCameraPermission === null) {
            // Request permission first, the effect will handle joining after grant
            requestCameraPermission();
            return;
        }
        ...
        setShowJoinModal(false); // Close modal on successful join attempt
        toast({
    ...
    // If permission was already granted, video stream should be active via useEffect
    };
    const handleGenerateCode = ()=>{
        const newCode = generateMeetingCode();
        setGeneratedCode(newCode);
        // Request permission immediately after generating code
        requestCameraPermission();
    };
    const handleStartMeeting = (code)=>{
        if (hasCameraPermission === null) {
            // Permission request is already in progress via handleGenerateCode -> requestCameraPermission
            return;
        }
        if (hasCameraPermission === false) {
            toast({
        ...
        console.log(`Starting new meeting with code: ${code}`);
        setMeetingCode(code); // Set the meeting code state
        setIsMeetingActive(true);
        toast({
    ...
    // Video stream should be active via useEffect
    };
    const handleLeaveMeeting = ()=>{
        ...
        // Reset permission state to trigger request again if needed
        // setHasCameraPermission(null); // Or keep it true if granted? Decide based on desired UX. Let's keep it true.
        toast({
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        hasCameraPermission === false && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "absolute inset-0 flex flex-col items-center justify-center bg-black/50 text-destructive-foreground p-4",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$video$2d$off$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__VideoOff$3e$__["VideoOff"], {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: t('page.videoCall.error.permissionRequired')
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/video-call/page.tsx",
                                                    lineNumber: 218,
                                                    columnNumber: 25
                                        ...
                                        hasCameraPermission === null && !isLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: t('page.videoCall.permissionNeeded')
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/video-call/page.tsx",
                                                lineNumber: 223,
                                                columnNumber: 25
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                    ...
                                    variant: "destructive",
                                    className: "w-full",
                                    children: t('page.videoCall.button.leaveMeeting')
                                }, void 0, false, {
                                    fileName: "[project]/src/app/video-call/page.tsx",
                                    lineNumber: 238,
                                    columnNumber: 15
                            ...
                            children: [
                                ...
                                user.role === 'CourtOfficial' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                                            className: "text-center",
                                            children: generatedCode ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "space-y-3",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-sm text-muted-foreground",
                                                        children: t('page.videoCall.shareCode')
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/video-call/page.tsx",
                                                        lineNumber: 281,
                                                        columnNumber: 29
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex items-center justify-center space-x-2 p-3 bg-muted rounded-md",
                                                        children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: t('page.videoCall.waitingForPermission')
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/video-call/page.tsx",
                                                        lineNumber: 288,
                                                        columnNumber: 30
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AlertDescription"], {
                                    children: [
                                        ...
                                        user.role === 'CourtOfficial' && ` ${t('page.videoCall.infoTextOfficial')}`
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/src/app/video-call/page.tsx",
                                    lineNumber: 318,
...
//# sourceMappingURL=_45fb146a._.js.map