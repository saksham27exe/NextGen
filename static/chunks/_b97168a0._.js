(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_b97168a0._.js", {
...
async function getCasesByUserId(userId) {
    ...
    try {
        ...
        // Dexie doesn't directly support OR queries across multiple fields easily without complex indexing.
        // It's often simpler to fetch all and filter client-side for moderate data sizes,
        // or use specific index queries and combine results. Let's filter client-side for this demo.
        const allCases = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].cases.toArray();
        const userCases = allCases.filter((c)=>c.plaintiffId === userId || c.defendantId === userId || c.judgeId === userId || c.lawyerIds && c.lawyerIds.includes(userId));
...
async function updateCase(caseNumber, updates) {
    try {
        ...
        const count = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].cases.update(caseNumber, updates);
        if (count > 0) {
            console.log('[LocalCaseService] Case updated successfully:', caseNumber);
        } else {
            console.warn('[LocalCaseService] Case update attempt failed, case not found:', caseNumber);
        }
        return count;
    } catch (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$local$2d$case$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/local-case-service.ts [app-client] (ecmascript)"); // Import Dexie service to fetch case
;
...
function AISummariesPage() {
    ...
    const [initialCaseNumber, setInitialCaseNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null); // Store case number instead of ID
    const { t, i18n } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$useTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"])(); // Initialize useTranslation
    // Fetch case data from Dexie if caseNumber is in query params
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AISummariesPage.useEffect": ()=>{
            const caseNumberFromQuery = searchParams.get('caseId'); // Parameter is actually caseNumber
            if (caseNumberFromQuery) {
                setInitialCaseNumber(caseNumberFromQuery);
                setIsLoading(true); // Set loading while fetching
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$local$2d$case$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCaseById"])(caseNumberFromQuery).then({
                    "AISummariesPage.useEffect": (foundCase)=>{
                        if (foundCase) {
                            // Format date using i18n locale
                            const formatDate = {
                                "AISummariesPage.useEffect.formatDate": (dateString)=>{
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    initialCaseNumber && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(AISummariesPage, "pM17AkMs84zC124WNyX62w9O/14=", false, function() {
    return [
...
//# sourceMappingURL=_b97168a0._.js.map