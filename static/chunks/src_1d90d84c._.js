(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_1d90d84c._.js", {
...
function LocaleProvider({ children }) {
    _s();
    const [locale, _setLocale] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_LOCALE"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LocaleProvider.useEffect": ()=>{
            const storedLocale = localStorage.getItem('nextgen-ecourt-locale');
            if (storedLocale && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SUPPORTED_LANGUAGES"].some({
                "LocaleProvider.useEffect": (lang)=>lang.code === storedLocale
            }["LocaleProvider.useEffect"])) {
                _setLocale(storedLocale);
            } else {
                // Optionally, could try to detect browser language here
                _setLocale(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_LOCALE"]);
            }
        }
    }["LocaleProvider.useEffect"], []);
    const setLocale = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LocaleProvider.useCallback[setLocale]": (newLocale)=>{
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SUPPORTED_LANGUAGES"].some({
                ...
                localStorage.setItem('nextgen-ecourt-locale', newLocale);
                document.documentElement.lang = newLocale; // Update lang attribute on html tag
            } else {
...
_s(LocaleProvider, "ytdM3iHI2PmM1B73ooC7x9g6UD0=");
_c = LocaleProvider;
function useLocale() {
    _s1();
...
function useTranslation() {
    _s();
    const { locale } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$LocaleContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocale"])();
    ...
    const [currentLocaleUsed, setCurrentLocaleUsed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(locale);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            ...
            async function loadTranslations(loc) {
                try {
                    const module = await __turbopack_context__.f({
                        ...
                        "@/locales/hi.json": {
                            id: ()=>"[project]/src/locales/hi.json (json, async loader)",
                            module: ()=>__turbopack_context__.r("[project]/src/locales/hi.json (json, async loader)")(__turbopack_context__.i)
                        }
                    }).import(`@/locales/${loc}.json`);
                    setTranslations(module.default || module);
                    setCurrentLocaleUsed(loc);
                } catch (error) {
                    console.error(`Failed to load translations for locale: ${loc}`, error);
                    if (loc !== __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_LOCALE"]) {
                        try {
                            console.warn(`Falling back to ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_LOCALE"]} locale.`);
                            const fallbackModule = await __turbopack_context__.f({
                                "@/locales/en.json": {
                                    id: ()=>"[project]/src/locales/en.json (json, async loader)",
                                    module: ()=>__turbopack_context__.r("[project]/src/locales/en.json (json, async loader)")(__turbopack_context__.i)
                                },
                            ...
                            }).import(`@/locales/${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_LOCALE"]}.json`);
                            setTranslations(fallbackModule.default || fallbackModule);
                            setCurrentLocaleUsed(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_LOCALE"]);
                        } catch (fallbackError) {
                            console.error(`Failed to load fallback ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$languages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_LOCALE"]} translations`, fallbackError);
                            setTranslations({}); // Empty translations if everything fails
                        }
                    } else {
                        setTranslations({});
                    }
    ...
    const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTranslation.useCallback[t]": (key, params)=>{
            ...
            if (translation === undefined) {
                console.warn(`Translation key "${key}" not found for locale "${currentLocaleUsed}".`);
...
_s(useTranslation, "2glk81Z/FNo2M7puJ5HhMQQRjwo=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTranslation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useTranslation.ts [app-client] (ecmascript)"); // Import useTranslation
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function UserProfile() {
    ...
    const { t } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTranslation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"])(); // Initialize useTranslation
    if (loading) {
...
function LanguageToggle() {
    _s();
    const { locale, setLocale, supportedLanguages } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$LocaleContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocale"])();
    const { t } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTranslation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"])(); // For translating "Select Language" if needed
...
_s(LanguageToggle, "tdsRxcX9sblsqEVSzP4p30Jr2V8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$LocaleContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocale"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTranslation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"]
    ];
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LanguageToggle$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/LanguageToggle.tsx [app-client] (ecmascript)"); // Import LanguageToggle
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTranslation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useTranslation.ts [app-client] (ecmascript)"); // Import useTranslation
;
var _s = __turbopack_context__.k.signature();
'use client';
...
function Header() {
    ...
    const { t } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTranslation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"])(); // Initialize useTranslation hook
    const baseNavItems = [
        {
            href: '/',
...
//# sourceMappingURL=src_1d90d84c._.js.map