(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_03d3bd7b._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$video$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Video$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/video.js [app-client] (ecmascript) <export default as Video>"); // Added Users, UserMinus, UserPlus
...
function VideoCallPage() {
    ...
    const [participantList, setParticipantList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const simulationIntervalRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null); // Ref to hold interval ID
    const startParticipantSimulation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VideoCallPage.useCallback[startParticipantSimulation]": ()=>{
            ...
            simulationIntervalRef.current = setInterval({
                "VideoCallPage.useCallback[startParticipantSimulation]": ()=>{
                    setParticipantList({
                        "VideoCallPage.useCallback[startParticipantSimulation]": (prevList)=>{
                            const action = Math.random();
                            if (action < 0.3 && prevList.length > 1) {
                                const randomIndex = Math.floor(Math.random() * (prevList.length - 1)) + 1; // Avoid removing self (index 0)
                                const removedName = prevList[randomIndex];
                                console.log(`[Sim] Participant left: ${removedName}`);
                                toast({
                                ...
                                return prevList.filter({
                                    "VideoCallPage.useCallback[startParticipantSimulation]": (_, index)=>index !== randomIndex
                                }["VideoCallPage.useCallback[startParticipantSimulation]"]);
                            } else if (action < 0.7) {
                                const availableNames = dummyParticipantNames.filter({
                                    "VideoCallPage.useCallback[startParticipantSimulation].availableNames": (name)=>!prevList.includes(name)
                                }["VideoCallPage.useCallback[startParticipantSimulation].availableNames"]);
                                if (availableNames.length > 0) {
                                    const randomIndex = Math.floor(Math.random() * availableNames.length);
                                    const newName = availableNames[randomIndex];
                                    console.log(`[Sim] Participant joined: ${newName}`);
                                    toast({
            ...
            }["VideoCallPage.useCallback[startParticipantSimulation]"], 7000); // Simulate join/leave every 7 seconds
        }
    }["VideoCallPage.useCallback[startParticipantSimulation]"], [
        t
    ]);
    const stopParticipantSimulation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VideoCallPage.useCallback[stopParticipantSimulation]": ()=>{
            if (simulationIntervalRef.current) {
                clearInterval(simulationIntervalRef.current);
                simulationIntervalRef.current = null;
                console.log("[Sim] Participant simulation stopped.");
            }
        }
    }["VideoCallPage.useCallback[stopParticipantSimulation]"], []);
    const requestCameraPermission = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VideoCallPage.useCallback[requestCameraPermission]": async (onSuccess)=>{
            setIsLoading(true);
            try {
    ...
    // Effect to request permission only if needed and meeting is intended to start
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VideoCallPage.useEffect": ()=>{
            // Cleanup function to stop media stream and simulation when component unmounts or meeting ends
            return ({
                "VideoCallPage.useEffect": ()=>{
                    if (videoRef.current && videoRef.current.srcObject) {
                        const stream = videoRef.current.srcObject;
                        stream.getTracks().forEach({
                            "VideoCallPage.useEffect": (track)=>track.stop()
                        }["VideoCallPage.useEffect"]);
                        console.log("Media stream stopped.");
                    }
                    stopParticipantSimulation(); // Stop simulation on unmount
                }
            })["VideoCallPage.useEffect"];
        }
    }["VideoCallPage.useEffect"], [
    ...
    const handleJoinMeeting = async ()=>{
        if (!meetingCode.trim()) {
            toast({
                variant: 'destructive',
                title: t('page.videoCall.error.codeRequired')
            });
            return;
        }
        const joinAction = ()=>{
            console.log(`Joining meeting with code: ${meetingCode}`);
            // In a real app, you'd validate the code and connect to a WebRTC service
            ...
            startParticipantSimulation(); // Start simulation on join
            toast({
        ...
        // Basic validation / permission check
        if (hasCameraPermission === true) {
            joinAction(); // Permission already granted
            ...
            // Request permission first, then join on success
            await requestCameraPermission(joinAction);
        }
    };
    const handleGenerateCode = async ()=>{
        const newCode = generateMeetingCode();
        setGeneratedCode(newCode);
        setMeetingCode(newCode); // Pre-fill code
        const startAction = ()=>{
            console.log(`Starting new meeting with code: ${newCode}`);
            setIsMeetingActive(true);
            if (user?.name) {
                setParticipantList([
                    user.name
            ...
            startParticipantSimulation(); // Start simulation on start
            toast({
        ...
        if (hasCameraPermission === true) {
            ...
            setGeneratedCode(null); // Reset generated code if permission denied
        } else {
            await requestCameraPermission(startAction);
        }
    };
    const handleLeaveMeeting = ()=>{
        ...
        setParticipantList([]); // Clear participants
        stopParticipantSimulation(); // Stop simulation on leave
        if (videoRef.current && videoRef.current.srcObject) {
            const stream = videoRef.current.srcObject;
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "aspect-video bg-muted rounded-lg overflow-hidden relative border",
                                    children: [
                                        ...
                                        hasCameraPermission === false && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "absolute inset-0 flex flex-col items-center justify-center bg-black/70 text-destructive-foreground p-4 text-center",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$video$2d$off$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__VideoOff$3e$__["VideoOff"], {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex flex-col sm:flex-row justify-between items-center gap-4 p-4 border rounded-md bg-muted/50",
                                    children: [
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuContent"], {
                                                    ...
                                                    children: [
                                                        ...
                                                        participantList.length > 0 ? participantList.map((name, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuItem"], {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "text-center text-muted-foreground text-sm p-4 border rounded-md",
                                    children: t('page.videoCall.placeholder.controls')
                                }, void 0, false, {
                                    fileName: "[project]/src/app/video-call/page.tsx",
                                    lineNumber: 306,
                                    columnNumber: 16
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardFooter"], {
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                ...
                                                className: "w-full",
                                                disabled: isLoading || !meetingCode || meetingCode.length !== 6,
                                                children: [
                                                    isLoading && !generatedCode ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                ...
                                user.role === 'CourtOfficial' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                    className: "flex-1 border-primary bg-primary/5 flex flex-col",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                        ...
                        !isMeetingActive && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                            variant: "default",
                            className: "mt-6",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$video$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Video$3e$__["Video"], {
...
_s(VideoCallPage, "2yqqv4mBERfrVXO5OJ79i4cqNU8=", false, function() {
    return [
...
//# sourceMappingURL=_03d3bd7b._.js.map