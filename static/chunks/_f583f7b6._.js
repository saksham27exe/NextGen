(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_f583f7b6._.js", {
...
function CaseDetailPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CaseDetailPage.useEffect": ()=>{
            if (caseId) {
                const foundCase = allCases.find({
                    "CaseDetailPage.useEffect.foundCase": (c)=>c.id === caseId
                }["CaseDetailPage.useEffect.foundCase"]);
                if (foundCase) {
                    setCaseData(foundCase);
                } else {
                    // This check should ideally happen after initial loading is complete
                    // and after attempts to load data for the specific caseId.
                    // For now, we delay pushing to 404 until loading state is explicitly false.
    ...
    const handleJudgeAction = (action)=>{
        ...
        if (action === 'Example Update Status to On Hold' && caseData) {
            const updatedCase = {
                ...caseData,
                status: 'On Hold',
                lastUpdate: new Date().toISOString()
            };
            setAllCases((prevCases)=>prevCases.map((c)=>c.id === caseId ? updatedCase : c));
        }
    };
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    if (!caseData) {
        // This could be a more user-friendly "Not Found" component
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            children: t('page.caseDetail.notFound')
        }, void 0, false, {
            fileName: "[project]/src/app/cases/[id]/page.tsx",
            lineNumber: 123,
            columnNumber: 12
    ...
    const formatDate = (dateString, includeTime = false)=>{
        ...
        try {
            ...
            return new Date(dateString).toLocaleDateString(t('na') === 'N/A' ? 'en-US' : undefined, options); // Fallback for locale issues
        } catch (e) {
            return dateString;
        }
    };
                        ...
                        children: [
                            ...
                            isJudgeAssignedToCase && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        variant: "outline",
                                        onClick: ()=>handleJudgeAction('Update Status Modal (Not Implemented)'),
                                        children: [
                                            ...
                                            " ",
                                            t('page.caseDetail.button.updateStatus')
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/cases/[id]/page.tsx",
                                        lineNumber: 221,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        variant: "outline",
                                        onClick: ()=>handleJudgeAction('Add Note Modal (Not Implemented)'),
                                        children: [
                                            ...
                                            " ",
                                            t('page.caseDetail.button.addNote')
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/cases/[id]/page.tsx",
                                        lineNumber: 224,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        variant: "outline",
                                        onClick: ()=>handleJudgeAction('Upload Document Modal (Not Implemented)'),
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$cloud$2d$upload$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__UploadCloud$3e$__["UploadCloud"], {
                                                className: "mr-2 h-4 w-4"
                                            }, void 0, false, {
                                            ...
                                            " ",
                                            t('page.caseDetail.button.uploadDocument')
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/cases/[id]/page.tsx",
                                        lineNumber: 227,
...
_s(CaseDetailPage, "wz1ZQLDwHPPJj2ghCgGvaMAlmKc=", false, function() {
    return [
...
_c1 = Section;
const InfoItem = ({ icon: Icon, label, value, highlight })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(DocumentItem, "XbQoRqPDPo6PJEzRId7w4FMisDk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
_c3 = DocumentItem;
const NoteItem = ({ note, t })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_f583f7b6._.js.map