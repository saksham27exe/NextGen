...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/firebase.ts [app-ssr] (ecmascript)"); // Import Firestore instance
...
// import { mockCases } from '@/data/mockData'; // Keep for potential fallback or testing
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/input.tsx [app-ssr] (ecmascript)"); // Import Input for search
...
function DashboardPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchCases = async ()=>{
            ...
            setIsLoading(true);
            const casesRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], 'cases');
            let qConstraints = [];
            // Build query based on user role
            switch(user.role){
                case 'Judge':
                    qConstraints.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])('judgeId', '==', user.id));
                    break;
                case 'Plaintiff':
                    qConstraints.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])('plaintiffId', '==', user.id));
                    break;
                case 'Defendant':
                    qConstraints.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])('defendantId', '==', user.id));
                    break;
                case 'Lawyer':
                    // Firestore limitation: Cannot query array directly with '==' for multiple values.
                    // Fetch all cases and filter client-side OR restructure data (e.g., lawyer subcollection).
                    // For simplicity, fetching all and filtering client-side here. Consider performance for large datasets.
                    // Alternatively, fetch cases where lawyerIds array-contains user.id
                    qConstraints.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])('lawyerIds', 'array-contains', user.id));
                    break;
                case 'CourtOfficial':
                    break;
                default:
                    // Unknown role or role without specific case view, show nothing
                    console.warn(`Unknown or unsupported role for case fetching: ${user.role}`);
                    setAllCases([]);
                    setFilteredCases([]);
                    setIsLoading(false);
                    return;
            ...
            if (statusFilter !== 'all') {
                qConstraints.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["where"])('status', '==', statusFilter));
            }
            // Construct the final query
            const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["query"])(casesRef, ...qConstraints);
            try {
                ...
                // Apply search term filtering client-side after fetching
                let finalFilteredCases = casesData;
                if (searchTerm) {
                    const lowerSearchTerm = searchTerm.toLowerCase();
                    finalFilteredCases = casesData.filter((c)=>c.caseNumber.toLowerCase().includes(lowerSearchTerm) || c.title.toLowerCase().includes(lowerSearchTerm) || c.plaintiff && c.plaintiff.toLowerCase().includes(lowerSearchTerm) || c.defendant && c.defendant.toLowerCase().includes(lowerSearchTerm));
                }
                setAllCases(casesData); // Store the full fetched list (based on role constraints)
                setFilteredCases(finalFilteredCases); // Set the filtered list for display
            } catch (error) {
        ...
        statusFilter,
        searchTerm
    ]); // Re-fetch when user, auth state, or filters change
    ...
    const uniqueStatuses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        // Calculate unique statuses from the currently fetched cases (respecting role filters)
    ...
    // Add more specific titles if needed for other roles
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Input"], {
                                ...
                                className: "pl-10 w-full bg-background" // Ensure input takes full width on small screens
                                ,
...
//# sourceMappingURL=_474f4857._.js.map